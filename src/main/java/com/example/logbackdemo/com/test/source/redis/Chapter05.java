package com.example.logbackdemo.com.test.source.redis;
...
public class Chapter05 {
    ...
    public void importIpsToRedis(Jedis conn, File file) {
        ...
        try{
            ...
            int count = 0;
            List line = null;
            while ((line = parser.getRecords()) != null){
                String startIp = line.size() > 1 ? (String) line.get(0) : "";
                ...
                String cityId = (String) line.get(1) + '_' + count;
    ...
    public void importCitiesToRedis(Jedis conn, File file) {
        ...
        try{
            ...
            List line = null;
            while ((line = parser.getRecords()) != null){
                if (line.size() < 4 || !Character.isDigit((Character) line.get(0))){
                    continue;
                }
                String cityId = (String) line.get(0);
                String country = (String) line.get(1);;
                String region = (String) line.get(2);;
                String city = (String) line.get(3);;
